...
```{r load functions}
plt_heatmap <- function(cmap_profile, profile_s2m, profile_d2m, df_smname_mapping, pval=0.05, ftitle="cmap", minN_miRNA=5, total_miRNA=10, cluster = T, row_order=F, col_order=F, outdir = "heatmap") {
